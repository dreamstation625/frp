...
For port multiplexing, frp sends a first byte `0x42` to dial a TLS connection. This only takes effect when you set `transport.tls.disableCustomTLSFirstByte` to false.
